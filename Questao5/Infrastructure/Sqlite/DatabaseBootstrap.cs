...
namespace Questao5.Infrastructure.Sqlite
{
    public class DatabaseBootstrap : IDatabaseBootstrap
    {
        ...
        public async Task<bool> InitializeDatabaseAsync(CancellationToken cancellationToken)
        {
            await Task.Run(() => Setup(), cancellationToken);
            return true;
        }
        ...
        public void Setup()
        {
            ...
            connection.Execute("INSERT INTO contacorrente(idcontacorrente, numero, nome, ativo) VALUES('382D323D-7067-ED11-8866-7D5DFA4A16C9', 789, 'Kevin Mcconnell', 1);");
